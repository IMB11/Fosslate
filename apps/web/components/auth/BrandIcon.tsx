...
const brandPaths = {
  ...
  gitlab:
    "M23.955 13.587l-1.342-4.135-2.664-8.189a.456.456 0 0 0-.87 0L16.414 9.45H7.586L4.922 1.263a.456.456 0 0 0-.87 0L1.386 9.45.044 13.587a.924.924 0 0 0 .331 1.023L12 23.054l11.625-8.443a.92.92 0 0 0 .33-1.024",
} as const;
