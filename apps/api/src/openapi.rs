...
#[openapi(
    paths(
        ...
        crate::routes::settings::get_account_security,
        crate::routes::settings::get_instance_settings,
        crate::routes::settings::remove_account_sso,
        crate::routes::settings::save_instance_sso_provider,
        crate::routes::settings::start_account_sso,
        crate::routes::settings::test_instance_email_delivery,
        crate::routes::settings::update_account_password,
    ...
    components(
        schemas(
            ...
            crate::models::AccountIdentity,
            crate::models::AccountSecurityResponse,
            crate::models::AccountSsoProvider,
            ...
            crate::routes::settings::UpdateAccountPasswordRequest,
